...
ggplot(lit_p, aes(names,probs1, fill=vowel)) + geom_bar(stat="identity")
ggplot(lit_p, aes(names,probs2, fill=vowel)) + geom_bar(stat="identity")
```
...
ggplot(lit_bp, aes(names,probs1, fill=vowel)) + geom_bar(stat="identity")
ggplot(lit_bp, aes(names,probs2, fill=vowel)) + geom_bar(stat="identity")
```
